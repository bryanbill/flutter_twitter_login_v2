...
public class SwiftTwitterLoginV2Plugin: NSObject, FlutterPlugin, ASWebAuthenticationPresentationContextProviding  {
    var session: Any? = nil

    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(
            name: "twitter_oauth_v2/auth_browser",
            binaryMessenger: registrar.messenger()
        )
        let instance = SwiftTwitterLoginV2Plugin()
